  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen w-full bg-gradient-to-b from-black via-[#0a0a1a] to-[#030014] text-white overflow-hidden px-5" id="experience">
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="relative flex flex-col md:flex-row items-start md:items-center justify-between w-full max-w-4xl bg-[#11112a]/70 border border-[#6b21a8]/30 rounded-2xl p-8 shadow-[0_0_25px_#6b21a8] mb-8"
      >
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="relative flex flex-col md:flex-row items-start md:items-center justify-between w-full max-w-4xl bg-[#11112a]/70 border border-[#6b21a8]/30 rounded-2xl p-8 shadow-[0_0_25px_#6b21a8]"
      >
        <div className="flex items-center justify-center bg-gradient-to-tr from-purple-500 to-cyan-400 w-14 h-14 rounded-full shadow-[0_0_20px_#06b6d4] text-white text-2xl font-bold">
          💼
        </div>
